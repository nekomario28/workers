...
public class WorkersHumanProfessionLayer extends RenderLayer<AbstractRecruitEntity, HumanoidModel<AbstractRecruitEntity>> {
    ...
    private static final ResourceLocation[] TEXTURE = {
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_miner_cloth.png"),
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_farmer_cloth.png"),
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_fisherman_cloth.png"),
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_animalfarmer_cloth.png"),
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_lumberjack_cloth.png"),
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_merchant_cloth.png"),
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_courier_cloth.png"),
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_builder_cloth.png"),
            ResourceLocation.fromNamespaceAndPath(WorkersMain.MOD_ID,"textures/entity/human/human_cook_cloth.png")
    };
